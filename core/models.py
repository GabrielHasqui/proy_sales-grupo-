...
from proy_sales.utils import valida_cedula,phone_regex,valida_decimal,valida_numero, valida_letras
...
class Product(models.Model):
    ...
    description = models.CharField('Articulo',max_length=100,validators=[valida_letras])
    cost=models.DecimalField('Costo Producto',max_digits=10,decimal_places=2,default=Decimal('0.0'))
    price=models.DecimalField('Precio',max_digits=10,decimal_places=2,default=Decimal('0.0'),validators=[valida_decimal])
    stock=models.IntegerField(default=100,help_text="Stock debe estar en 0 y 10000 unidades",verbose_name='Stock', validators=[valida_numero])
...
class Category(models.Model):
    description = models.CharField(verbose_name='Categoria',max_length=100,validators=[valida_letras])
    user = models.ForeignKey(User,on_delete=models.CASCADE)
    created = models.DateTimeField(auto_now_add=True)
    updated = models.DateTimeField(auto_now=True)
    state = models.BooleanField('Activo', default = True)
